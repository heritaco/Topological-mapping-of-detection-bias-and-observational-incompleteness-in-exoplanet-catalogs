...
CANDIDATE_ALIASES: Dict[str, list[str]] = {
    ...
    "pl_orbper": ["p_star", "p_candidate", "p_candidate_days", "period_candidate", "period_days", "pl_orbper", "orbital_period"],
    "pl_orbsmax": ["a_star", "a_candidate", "a_candidate_au", "semimajor_candidate", "a_au", "pl_orbsmax", "semi_major_axis"],
    ...
    "candidate_score": ["candidate_score", "score", "priority_score"],
    "topology_score": ["topology_score", "mapper_score", "topological_score"],
    "gap_score": ["gap_score"],
    "toi": ["toi", "TOI", "topological_observational_incompleteness"],
    "ati": ["ati", "ATI", "anchor_topological_incompleteness"],
    "shadow_score": ["shadow_score", "shadow"],
}
